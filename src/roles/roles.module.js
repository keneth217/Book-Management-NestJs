...
var RolesModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([role_entity_1.Role])], // Register RoleRepository
    ...
    var _classThis;
    var RolesModule = _classThis = /** @class */ (function () {
        function RolesModule_1() {
        }
        return RolesModule_1;
    }());
