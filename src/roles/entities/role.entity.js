...
var Role = function () {
    ...
    var Role = _classThis = /** @class */ (function () {
        function Role_1() {
            ...
            this.users = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _users_initializers, void 0));
    ...
    (function () {
        ...
        _users_decorators = [(0, typeorm_1.ManyToMany)(function () { return user_entity_1.User; }, function (user) { return user.roles; })];
