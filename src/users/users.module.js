...
var UsersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, role_entity_1.Role]), // Ensure UserRepository and RoleRepository are available
                roles_module_1.RolesModule, // Import the RolesModule so RoleRepository is accessible
            ],
