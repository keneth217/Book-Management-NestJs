...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.roles = (__runInitializers(this, _phone_extraInitializers), __runInitializers(this, _roles_initializers, void 0));
            this.books = (__runInitializers(this, _roles_extraInitializers), __runInitializers(this, _books_initializers, void 0)); // Books borrowed by the user
    ...
    (function () {
        ...
        _roles_decorators = [(0, typeorm_1.ManyToMany)(function () { return role_entity_1.Role; }, function (role) { return role.users; }, { cascade: true }), (0, typeorm_1.JoinTable)()];
        _books_decorators = [(0, typeorm_1.OneToMany)(function () { return book_entity_1.Book; }, function (book) { return book.borrowedBy; })];
