...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.changeRole = function (id, changeRoleDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.assignRole(id, changeRoleDto.role)];
                });
            });
        };
        UsersController_1.prototype.removeRole = function (id, changeRoleDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.removeRole(id, changeRoleDto.role)];
                });
            });
        };
    ...
    (function () {
        ...
        _changeRole_decorators = [(0, common_1.Patch)(':id/role/add')];
        _removeRole_decorators = [(0, common_1.Patch)(':id/role/remove')];
        ...
        __esDecorate(_classThis, null, _removeRole_decorators, { kind: "method", name: "removeRole", static: false, private: false, access: { has: function (obj) { return "removeRole" in obj; }, get: function (obj) { return obj.removeRole; } }, metadata: _metadata }, null, _instanceExtraInitializers);
